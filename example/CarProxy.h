...
class CarProxy : public libmexclass::proxy::Proxy {
    public:
        CarProxy(const libmexclass::proxy::FunctionArguments& constructor_arguments) : car{convert(constructor_arguments, 0), convert(constructor_arguments, 1), convert(constructor_arguments, 2)} {
